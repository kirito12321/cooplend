...
import 'package:ascoop/web_ui/controllers/timecontrol.dart';
...
class ListSubsReq extends StatefulWidget {
  ListSubsReq({
    super.key,
  });

  @override
  State<ListSubsReq> createState() => _ListSubsReqState();
}

class _ListSubsReqState extends State<ListSubsReq> {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          HeaderText(
            Ttl: 'All Subscriber Requests',
            subTtl: 'Subscriber Requests',
          ),
          Expanded(
            child: SubList(),
          ),
...
class SubReqList extends StatefulWidget {
  String searchStr;
  bool isSearch;
  SubReqList({this.searchStr = '', required this.isSearch, super.key});

  @override
  State<SubReqList> createState() => _SubReqListState();
}

class _SubReqListState extends State<SubReqList> {
                  ...
                  builder: (context, snapshot) {
                    try {
                      ...
                      if (snapshot.hasError) {
                              ...
                              children: [
                                Visibility(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      '${NumberFormat('###,###,###').format(data.length.toInt())} Subscriber Requests',
                                      style: TextStyle(
                        ...
                        return EmptyData(ttl: 'No Subscriber Request Yet');
                      }
                    } catch (e) {
