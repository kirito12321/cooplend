...
class ListSubsAct extends StatefulWidget {
  ListSubsAct({
    super.key,
  });

  @override
  State<ListSubsAct> createState() => _ListSubsActState();
}

class _ListSubsActState extends State<ListSubsAct> {
  @override
...
class ProfileSubMob extends StatefulWidget {
  String name, subId;
  ProfileSubMob({
    super.key,
    required this.name,
  ...
  @override
  State<ProfileSubMob> createState() => _ProfileSubMobState();
}

class _ProfileSubMobState extends State<ProfileSubMob> {
  int index = 0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SubProfile(subId: widget.subId),
    );
  }
}
