...
class BookNavs extends StatefulWidget {
  const BookNavs({super.key});

  @override
  State<BookNavs> createState() => _BookNavsState();
}

class _BookNavsState extends State<BookNavs> {
  void select(int n) {
      ...
      children: [
        ...
        NavBarItems(
          ...
          touched: () {
            ...
            Navigator.pushNamed(context, '/payments/paid');
          },
        ),
